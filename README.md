...
- `Boolean active` - active or disabled
...
- Parameters: None
- Description: If the logged-in user is a **Master**, the current question of their open game will be displayed (only one game can be open at a time), there also will be a button to delete the game. If no games are open, there will be a button to create a new game. If the logged-in user is a **Player**, the stats screen will be shown.
- Methods called:
	- (Master)[[README#Get open game method]]
	- (Master)[[README#Delete Game method]]
	- (Master)[[README#Answer the Question method]]
...
- Methods called:
	...
	- (Master)[[README#Add Player method]]
	- (Master)[[README#Remove Player method]]
### Get all users
- URL: `{{BASEURL}}/user-list`
- Role allowed: Master/Player
- Parameters: None
- Description: This page display the list of all users in the game, with 3 buttons for each user to delete, enable/disable, change the user role.
- Methods called:
	- (Master)[[README#Get all users]]
	- (Master)[[README#Enable or Disable User method]]
	- (Master)[[README#Delete User method]]
	- (Master)[[README#Update Role method]]
